...
async function go() {
  ...
  fd.append('body', 'тест аудио в посте 2')
  fd.append('communityId', '')
  fd.append('nsfw', '0')
  fd.append('attachmentMeta', JSON.stringify([
    { type: 'audio', lib: { kind: 'audio', id: 163, url: '/uploads/1785869913879-886861549.mp3', name: 'Test Track', cover: null } }
  ]))
